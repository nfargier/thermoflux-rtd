...
This page provides an extended overview of the key steps and concepts involved in using the Thermo-Flux package for thermodynamic flux analysis integrated with COBRApy. It covers parameter definitions, metabolite handling, Gibbs energy calculations, reaction balancing, thermodynamic modeling, and regression fitting.

Step 1: Definition of physical and biochemical parameters
*********************************************************

For definition of membrane potentials, ``ce`` represents the voltage between compartment ``c`` and compartment ``e`` defined as ``Phi_c - Phi_e``.
...
.. rubric:: Box 2: Additional considerations for the calculation of Gibbs formation energies
...
.. rubric:: Box 3: Transporter variants
...
.. rubric:: Box 4: Compartmented metabolite concentrations and whole cell concentrations
...
.. rubric:: Box 5: Model starting points
